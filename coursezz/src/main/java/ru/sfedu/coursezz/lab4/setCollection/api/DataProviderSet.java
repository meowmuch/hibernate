...
public class DataProviderSet implements IDataProviderSet {
    ...
    @Override
    public Long createClient(String name, String login, String password,
                             Set<Plan> planList) {
    ...
    @Override
    public ResultType updateClient(Long id, String name, String login, String password,
                                   Set<Plan> planList) {
        try {
